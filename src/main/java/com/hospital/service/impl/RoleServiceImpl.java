...
import com.hospital.common.enums.ResponseCodeEnum;
import com.hospital.common.exception.BusinessException;
import com.hospital.domain.base.PageResult;
import com.hospital.domain.dto.RoleDTO;
import com.hospital.domain.dto.RolePageQueryDTO;
import com.hospital.domain.entity.Role;
import com.hospital.domain.vo.RoleVO;
...
public class RoleServiceImpl implements RoleService {
	...
	public boolean deleteByIds(List<Long> ids) {
		...
		if (count > 0) {
			throw new com.hospital.common.exception.BusinessException("选中的角色中有关联用户，无法删除");
		}
		// 同时删除角色与菜单的关联（防止脏数据）
		for (Long roleId : ids) {
